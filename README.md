# 🎨 Shadcn/UI AspectRatio for Weweb

Beautiful **AspectRatio component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-aspectratio`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The AspectRatio component will appear in your elements!
...
├── src/
│   ├── AspectRatio.vue    # Vue.js component
│   ├── cn.js            # CSS utility
